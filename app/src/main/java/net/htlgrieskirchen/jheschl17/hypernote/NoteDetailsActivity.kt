...
import net.htlgrieskirchen.jheschl17.hypernote.util.noteFromSerializationString
...
class NoteDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val note = noteFromSerializationString(intent.getStringExtra("note") as String)
